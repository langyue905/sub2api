...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	affiliateService := service.ProvideAffiliateService(affiliateRepository, agentRepository, settingService, apiKeyAuthCacheInvalidator, billingCacheService)
	...
	usageLogRepository := repository.ProvideUsageLogRepository(client, db, affiliateService)
