export default {
  ...
  auth: {
    ...
    invalidUsername: "Username cannot contain spaces or {'@'} and must be 100 characters or fewer",
    emailLabel: 'Email',
    ...
    loginIdentifierPlaceholder: 'Enter your username or email',
    loginIdentifierRequired: 'Username or email is required',
    ...
    errors: {
      ...
      USERNAME_EXISTS: 'That username is already in use. Please choose another.',
